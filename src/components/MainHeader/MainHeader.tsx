...
const MainHeader: React.FC = () => {
  // convert header include search bar and notification and user profile using tailwind
  return (
    <nav className='border-b bg-gradient-to-r from-[#ffe1bc] via-[#ffcfd1] to-[#f3c6f1]  border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50'>
      <div className='flex flex-wrap justify-between items-center'>
        <div className='flex justify-start items-center'>
          ...
          <a href='https://flowbite.com' className='flex items-center justify-between mr-4'>
            <img src='/images/vegetable.png' className='mr-3 h-8' alt='TTFood Logo' />
            <span className='self-center text-2xl font-semibold whitespace-nowrap text-apps-black dark:text-white'>
              TTFo<span className='text-apps-pink'>o</span>d
            </span>
          </a>
          <form action='#' method='GET' className='hidden md:block md:pl-24'>
