...
import './MasterCardLayout.css'
interface IMasterCardLayoutProps {
  cardNumber: string
  expiredDate: string
  cardHolderName: string
}

export const MasterCardLayout: React.FC<IMasterCardLayoutProps> = ({ cardNumber, cardHolderName, expiredDate }) => {
  return (
    <div className='flip-card'>
      <div className='flip-card-inner'>
        ...
        MDowMIXeN6gAAAAASUVORK5CYII='
          ...
          <p className='date_8264'>{expiredDate}</p>
