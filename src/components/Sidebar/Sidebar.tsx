...
const DialogLogout = lazy(() => import('~/components/DialogDefault'))
const Sidebar: FC = () => {
  ...
  const handleLogout = () => setOpen((prevState) => !prevState)
  return (
    <>
      <aside
        className='fixed top-0 left-0 z-40 w-64 h-screen pt-14 transition-transform -translate-x-full bg-apps-glass border-r border-gray-200 md:translate-x-0 dark:bg-gray-800 dark:border-gray-700'
        aria-label='Sidenav'
      ...
      <Suspense>
        <DialogLogout showDialog={open}>
          {logoutMutation.isPending && (
            <div className='flex items-center justify-center w-96 h-24 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700'>
              <div role='status'>
                <svg
                  aria-hidden='true'
