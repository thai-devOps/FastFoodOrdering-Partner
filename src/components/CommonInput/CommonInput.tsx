...
export default function CommonInput<TFieldValues extends FieldValues = FieldValues>({
  errorMessage,
  className,
  name,
  register,
  ...
  classNameInput = 'px-3 py-3.5 w-full outline-none border border-gray-300 focus:border-gray-500 rounded-md focus:shadow-sm',
  ...
  return (
    <div className={'relative ' + className}>
      ...
      {toggleButton && rest.type === 'checkbox' && (
