...
interface Props<TFieldValues extends FieldValues> extends InputHTMLAttributes<HTMLTextAreaElement> {
  errorMessage?: string
...
export default function TextArea<TFieldValues extends FieldValues = FieldValues>({
  ...
  cols = 30,
  label,
  classNameLable = 'block text-sm font-medium text-gray-700 mb-1',
  ...
  return (
    <div className={'relative ' + className}>
      <div className={classNameLable}>
        {label} {requiredInput ? <span className='text-red-500'>*</span> : null}
      </div>
      <textarea rows={rows} cols={cols} className={classNameInput} {...registerResult} {...rest}></textarea>
