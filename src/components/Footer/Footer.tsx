    ...
    <footer className='w-full text-slate-400'>
      ...
      <div className='pt-16 pb-12 text-sm border-t border-slate-900 bg-slate-800'>
        <div className='container px-6 mx-auto'>
          <div className='grid gap-10 items-center grid-cols-1 sm:grid-cols-2 md:grid-cols-3 md:justify-center'>
            <nav className=''>
          ...
          <div className='grid grid-cols-4 gap-6 md:grid-cols-8 lg:grid-cols-12'>
            ...
            >
              ...
              <ul className='flex items-center justify-end gap-4'>
                <li>
                  <a href='#' className='transition-colors duration-300 hover:text-emerald-500'>
                    <svg
                      xmlns='http://www.w3.org/2000/svg'
                      fill='none'
                      viewBox='0 0 48 48'
